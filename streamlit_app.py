...
def load_ontology():
    g = Graph()
    g.parse("bibliotheque.ttl", format="turtle")
    return g
        ...
        with col1:
            if st.button("Vérifier cohérence emprunts"):
                ...
                SELECT ?emprunt ?membre ?document WHERE {
                    ...
                    ?emprunt bib:effectuePar ?membre .
                    ?emprunt bib:porteSur ?document .
                    OPTIONAL { ?membre a bib:Membre . }
                    OPTIONAL { ?document a bib:Document . }
        ...
        with col2:
            if st.button("Vérifier dates emprunts"):
                ...
                SELECT ?emprunt ?dateDebut ?dateFin WHERE {
                    ?emprunt a bib:Emprunt .
                    ?emprunt bib:dateDebut ?dateDebut .
                    ?emprunt bib:dateFin ?dateFin .
...
PREFIX bib: <http://www.semanticweb.org/junior/ontologies/2026/0/bibliotheque#>"""
        ...
        # Zone de requête principale - plus simple sans sélection pré-définie
        default_query = """SELECT ?livre ?titre
WHERE {
        ...
        if execute and query:
            try:
                ...
                with st.expander("🛠️ Aide au débogage"):
                    ...
                    st.code("""PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
PREFIX bib: <http://www.semanticweb.org/junior/ontologies/2026/0/bibliotheque#>
...
LIMIT 10""", language="sparql")
        ...
        # Graphique des statistiques générales seulement (pas "Types les plus fréquents")
        ...
        # Analyse des patterns - seulement le tableau, pas le graphique
        ...
        if patterns:
            ...
            # Note: Le graphique des types les plus fréquents a été supprimé comme demandé
